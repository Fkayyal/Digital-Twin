...
INSERT INTO Soort (naam, kosten_per_meter, opbrengst, eenheidstype, leefbaarheids_score, aantal_mensen) VALUES
                                                                                                            ('Vrijstaande woning',           500, 12, 'm3', 4,  5),
                                                                                                            ('Rijtjeswoning',                400,  8, 'm3', 6, 10),
                                                                                                            ('Appartement',                  300, 12, 'm3', 5,  6),
                                                                                                            ('Bedrijfsgebouw',               200, 15, 'm3', 2, 18),
                                                                                                            ('Park / groen',                 150,  0, 'm2',10, NULL),
                                                                                                            ('Wegen',                        100,  5, 'm2', 8, NULL),
                                                                                                            ('Parkeerplaatsen',              100, 10, 'm2', 6, NULL),
                                                                                                            ('Overdekte parkeerplaatsen',   1500, 15, 'm2',10, NULL);

-- 3. Nieuwe DOEL‑records invoegen
INSERT INTO Doel (Omschrijving, Aantal) VALUES
                                            ('Aantal inwoners dat binnen het gebied moet kunnen wonen',                          3000),
